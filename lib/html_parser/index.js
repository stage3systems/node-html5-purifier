    ...
    function(attributeSanitizedHtml, cb) {
      ...
      if (typeof prefix !== 'undefined' || typeof postfix !== 'undefined') {
        ...
        async.whilst(function() {
          ...
          namespacer.stripNamespace(attributeSanitizedHtml, prefix, postfix, function(err, revertedHtml, replaced, hasClass) {
            attributeSanitizedHtml = revertedHtml;
            if (!hasClass) {
              attributeSanitizedHtml = revertedHtml.replace('class = ""', '')
            }
            isReplaced = replaced;
            cb();
          });
